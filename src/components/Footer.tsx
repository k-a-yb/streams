...
const Footer = () => {
  return (
    <footer className="glass-card border-t border-white/10 py-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><Link to="/movies" className="text-white/70 hover:text-neon-pink transition-colors">Movies</Link></li>
              <li><Link to="/tvshows" className="text-white/70 hover:text-neon-pink transition-colors">TV Shows</Link></li>
              <li><Link to="/collection" className="text-white/70 hover:text-neon-pink transition-colors">My Collection</Link></li>
              <li><Link to="/search" className="text-white/70 hover:text-neon-pink transition-colors">Search</Link></li>
            </ul>
          </div>
